...
<template>
  <div class="page-wrapper">
    <header class="page-header">
      <img src="/logo.png" alt="Codebat" class="logo" />
      <h1>Codebat ShareFile</h1>
    </header>
    ...
    <footer class="page-footer">
      <p class="footer-warning">For internal use only. Do not distribute externally.</p>
      <p class="footer-copyright">&copy; {{ new Date().getFullYear() }} Codebat Technologies. All rights reserved.</p>
    </footer>
  </div>
</template>
