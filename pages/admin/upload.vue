...
const handleUpload = async () => {
  ...
  try {
    ...
    const data = await response.json()
    // Replace localhost URL with share.codebat.ai
    data.downloadUrl = data.downloadUrl.replace(/https?:\/\/[^\/]+/, 'https://share.codebat.ai')
    data.downloadUrlWithPassword = data.downloadUrlWithPassword.replace(/https?:\/\/[^\/]+/, 'https://share.codebat.ai')
